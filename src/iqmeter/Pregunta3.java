...
public class Pregunta3 extends javax.swing.JFrame {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        Resultados.preguntas[2][0]=jLabel2.getText();
        Resultados.preguntas[2][1]=jButton4.getText();
        Resultados.preguntas[2][2]="Correcta";
        
        Pregunta4 interfaz = new Pregunta4();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Resultados.preguntas[2][0]=jLabel2.getText();
        Resultados.preguntas[2][1]=jButton1.getText();
        Resultados.preguntas[2][2]="Incorrecta";
        Pregunta4 interfaz = new Pregunta4();
        this.setVisible(false);
        interfaz.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Resultados.preguntas[2][0]=jLabel2.getText();
        Resultados.preguntas[2][1]=jButton2.getText();
        Resultados.preguntas[2][2]="Incorrecta";
        Pregunta4 interfaz = new Pregunta4();
        this.setVisible(false);
        interfaz.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        Resultados.preguntas[2][0]=jLabel2.getText();
        Resultados.preguntas[2][1]=jButton3.getText();
        Resultados.preguntas[2][2]="Incorrecta";
        Pregunta4 interfaz = new Pregunta4();
        this.setVisible(false);
        interfaz.setVisible(true);
